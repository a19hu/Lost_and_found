...
<div class="center">
        ...
        ?>
        <form action="registration.php" method="post" class="form" name="submit-to-google-sheet" id="myForm" onsubmit="return checkWords()">
            Your name:<br><input type="text" class="number" name="fullname" placeholder="Full Name:"><br>
            Email:<br> <input type="text" id="textInput" class="number" name="email" placeholder="Email:"><br>
