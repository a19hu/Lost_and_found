...
if(isset($_POST['done'])){
 ...
 $q = "INSERT INTO `cart`(`name`, `price`,`picture`,`buy`) VALUES  ('$username','$price','$picture','$buy')";
            ...
            <div class="body">
                ...
                <ul id="myUL">
                    <div class='box filterDiv gas'>
                        <div class='img-box'>
                            <img class='images' src="Kitchen/images (1).jpg">
                        </div> 
                        <div class='bottom'>
                            <div class="filterDiv gas"><a href="#" name="name"> utensils</a></div><br>
                            <h2 name="price">&#8377 500.00/- </h2>
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                <input type="hidden" class="file" name="name"  value="utensils">
                                <input type="hidden" class="file" name="price"  value="&#8377 500.00/-">
                                <input type="hidden" class="file" name="buy"  value="buy.php">
                                <input type="hidden" class="file" name="picture"  value="kitchen/images (1).jpg">
                    ...
                    <div class='box filterDiv gas'>
                        <div class='img-box'>
                            <img class='images' src="kitchen/images (14).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="&#8377 500.00/- ">
                                <input type="hidden" class="file" name="picture"  value="kitchen/images (14).jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv gas'>
                        <div class='img-box'>
                            <img class='images' src="kitchen/images (13).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="kitchen/images (13).jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv spooons'>
                        <div class='img-box'>
                            <img class='images' src="kitchen/images (17).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="kitchen/images (17).jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="kitchen/images (4).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="kitchen/images (4).jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv rack'>
                        <div class='img-box'>
                            <img class='images' src="kitchen/images.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="kitchen/images.jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="kitchen/detalle-de-interior-de.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="kitchen/detalle-de-interior-de.jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="Kitchen/images (16).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="&#8377 500.00/-">
                                <input type="hidden" class="file" name="picture"  value="kitchen/images (16).jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="Kitchen/images (5).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="buy"  value="buy.php">
                                <input type="hidden" class="file" name="picture"  value="kitchen/images (5).jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="Kitchen/images (3).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="${price}.00">
                                <input type="hidden" class="file" name="picture"  value="kitchen/images (3).jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv lids'>
                        <div class='img-box'>
                            <img class='images' src="Kitchen/images (10).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="kitchen.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="${price}.00">
                                <input type="hidden" class="file" name="picture"  value="kitchen/images (10).jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
