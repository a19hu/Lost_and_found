        ...
        <div class="data">
            ...
            <div class="body">
                ...
                <ul id="myUL">
                    ...
                    <div class='box filterDiv gas'>
                        <div class='img-box'>
                            <img class='images' src="khana/greenkurkure.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="picture"  value="khana/greenkurkure.jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv gas'>
                        <div class='img-box'>
                            <img class='images' src="khana/download.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="khana/download.jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv spooons'>
                        <div class='img-box'>
                            <img class='images' src="khana/download (4).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="khana/download (4).jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="khana/download (3).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="khana/download (3).jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv rack'>
                        <div class='img-box'>
                            <img class='images' src="khana/download (2).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="khana/download (2).jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="khana/download (1).jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="khana/download (1).jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="khana/doritos.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="&#8377 500.00/-">
                                <input type="hidden" class="file" name="picture"  value="khana/doritos.jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="khana/bluelays.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="${price}.00">
                                <input type="hidden" class="file" name="picture"  value="khana/bluelays.jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="khana/bingo.webp">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="food.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="${price}.00">
                                <input type="hidden" class="file" name="picture"  value="khana/bingo.webp">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
