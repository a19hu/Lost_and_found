            ...
            <div class="body">
                ...
                <ul id="myUL">
                    <div class='box filterDiv gas'>
                        <div class='img-box'>
                            <img class='images' src="fashion/Girls shoe.jpg">
                        </div> 
                        <div class='bottom'>
                            <div class="filterDiv gas"><a href="#" name="name"> utensils</a></div><br>
                            <h2 name="price">&#8377 500.00/- </h2>
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                <input type="hidden" class="file" name="name"  value="utensils">
                                <input type="hidden" class="file" name="price"  value="${price}.00">
                                <input type="hidden" class="file" name="picture"  value="fashion/Girls shoe.jpg">
                    ...
                    <div class='box filterDiv gas'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-pixabay-68201.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="picture"  value="fashion/pexels-pixabay-68201.jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv gas'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-matheus-bertelli-2905238.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="fashion/pexels-matheus-bertelli-2905238.jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv spooons'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-lumn-322207.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="fashion/pexels-lumn-322207.jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-ivan-samkov-7671168.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="fashion/pexels-ivan-samkov-7671168.jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv rack'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-fstopper-1075189.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="fashion/pexels-fstopper-1075189.jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-fernando-arcos-190819.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="fashion/pexels-fernando-arcos-190819.jpg">
                                <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-dids-1625037.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="&#8377 500.00/-">
                                <input type="hidden" class="file" name="picture"  value="fashion/pexels-dids-1625037.jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-aman-jakhar-2048548.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="${price}.00">
                                <input type="hidden" class="file" name="picture"  value="fashion/pexels-aman-jakhar-2048548.jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv cars'>
                        <div class='img-box'>
                            <img class='images' src="fashion/pexels-aditya-aiyar-1407354.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="${price}.00">
                                <input type="hidden" class="file" name="picture"  value="fashion/pexels-aditya-aiyar-1407354.jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
                    <div class='box filterDiv lids'>
                        <div class='img-box'>
                            <img class='images' src="fashion/Girls t shirt.jpg">
                        </div> 
                        <div class='bottom'>
                            ...
                            <form action="fashion.php" method="post" enctype="multipart/form-data" id="myForm" onsubmit="return checkWords()">
                                ...
                                <input type="hidden" class="file" name="price"  value="${price}.00">
                                <input type="hidden" class="file" name="picture"  value="fashion/Girls t shirt.jpg">
                               <div class="add"> <input type="submit" value="Add to cart" name="done" ></div>
                            </form>
                        </div>
                    </div>
